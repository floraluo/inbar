      ...
      <div class="media account-info">
        <div class="media-left">
          <div class="avatar avatar-online">
            <img src="../../static/images/avatar.svg" alt="admin">
        ...
        <div class="media-body">
          ...
          <p>
            <i class="icon icon-color wb-bell" aria-hidden="true"></i> 这是您第 {{ count }} 次登录，上次登录日期：{{ time }}，详细信息请查看
            <a href="/system/account#log" data-iframe target="_blank">日志</a>
            ，如果不是您本人登录，请及时
            <a href="/system/account#password" data-iframe target="_blank">修改密码</a>
            。
          </p>
        </div>
        <div class="media-right">
          <a href="${ctx}/system/account" data-iframe target="_blank"
          ...
          <div class="panel introduce-info">
            ...
            <div class="panel-body">
              <div class="media">
                <div class="media-left">
                  <a href="javascript:;">
                    <img class="media-object" src="../../static/images/admui-desktop.svg" alt="...">
                  </a>
                ...
                <div class="media-body">
                  ...
                  <div>
                    <a href="http://www.admui.com/" class="btn btn-success btn-sm btn-outline btn-round"
                       target="_blank">
                      返回官网
                    </a>
                    <a href="http://docs.admui.com/iframe/"
                       class="btn btn-danger btn-sm btn-outline btn-round" target="_blank">
                      开发文档
                    </a>
                    <a href="http://www.admui.com/about"
        ...
        <div class="col-md-5">
          <div class="panel changelog-info">
            <div class="panel-heading">
              <ul class="panel-actions">
                <li>
                  <a href="http://docs.admui.com/iframe/logs/" target="_blank">更多</a>
                </li>
              </ul>
            ...
            <div class="panel-body">
              <ul class="time-line">
                <li>
                  ...
                  <h5>
                    <a href="http://docs.admui.com/iframe/logs/v1.1.0/" target="_blank">Admui v1.1.0
                      正式发布</a>
                  </h5>
                </li>
                <li>
                  ...
                  <h5>
                    <a href="http://docs.admui.com/iframe/logs/v1.0.0/" target="_blank">Admui v1.0.0
                      正式发布</a>
                  </h5>
                </li>
                <li>
                ...
                <li>
                  <time datetime="2016-07-21">2016-07-21</time>
...
import $ from 'jquery'
import '../../static/vendor/matchheight/jquery.matchHeight.min.js'
...
export default {
  ...
  mounted () {
    $('[data-plugin=matchHeight]>div').matchHeight()
  }
}
</script>
