  ...
  <div class="page-main">
    ...
    <div class="order-panel">
      ...
      <div class="order-panel-body">
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-md-3">操作人：<span>{{order.operatedBy}}</span></div>
          <div class="col-xs-12 col-sm-6 col-md-3">提货数量：<span>{{order.goodsNum}}</span></div>
          <div class="col-xs-12 col-sm-6 col-md-3">订单时间：<span>{{orderTime}}</span></div>
          <div class="col-xs-12 col-sm-6 col-md-3">备注信息：<span>{{order.remark || '--'}}</span></div>
        </div>
      </div>
    </div>
    <div class="order-panel">
  ...
  export default {
    ...
    data() {
      return {
        ...
        orderType: '',
        columns: [
          {field: 'serialNum', title: '序号', width: 50, titleAlign: 'center', columnAlign: 'center', isResize: true, formatter: (rowData, rowIndex) => { return rowIndex + 1 }},
          ...
          {field: 'goodsPrice', title: '售价/元', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true},
