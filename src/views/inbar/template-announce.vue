  ...
  export default {
    ...
    methods: {
      ...
      initAddannounceParams(msg, params) {
        ...
        Object.keys(this.announceParam).forEach(key => {
    ...
    created() {
      vm = this;
      getALLAnnounce();
      subscribe('layer.opened.announce', this.initAddannounceParams)
      subscribe('layer.modify.save.announce', this.modifySave);
