    ...
    <div class="page-main">
      <div class="page-main-top">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation"><router-link to="/inbar/setting/area">区域设置</router-link></li>
          <li class="active" role="presentation"><router-link to="/inbar/setting/computer">电脑设置</router-link></li>
        </ul>
